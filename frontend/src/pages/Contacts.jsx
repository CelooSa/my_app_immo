    ...
    fetch("http://localhost:1337/api/autres-contacts?populate=*")
      ...
      .then((json) => {
        const loadedContacts = json.data.map((item) => ({
          id: item.id,
          ...item.attributes,
          specialites: Array.isArray(item.attributes.specialites)
            ? item.attributes.specialites
            : [],
          tags: Array.isArray(item.attributes.tags?.data)
            ? item.attributes.tags.data.map((tag) => tag.attributes.name)
            : [],
          documents: Array.isArray(item.attributes.documents?.data)
            ? item.attributes.documents.data.map((doc) => ({
        ...
        setContacts((prevContacts) => {
          ...
          const newContacts = loadedContacts.filter(
                    ...
                    <div className="form-row">
                      <label>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(contact.id, "prenom", e.target.value)
                          }
                        />
                      </label>
                      <label>
                        ...
                        <input
                          ...
                          value={contact.nom || ""}
                          onChange={(e) =>
                            handleChange(contact.id, "nom", e.target.value)
                          }
                        />
                      </label>
                    </div>
                    ...
                    <div className="form-row">
                      ...
                      <label>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(contact.id, "site_web", e.target.value)
                          }
                        />
                      </label>
                    </div>
                    ...
                    <div className="form-row">
                      <label>
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            handleChange(contact.id, "adresse", e.target.value)
                          }
                          rows={3}
                        />
                      </label>
                    ...
                    <div className="form-row">
                      <label>
                        ...
                        <input
                          ...
                          value={contact.ville || ""}
                          onChange={(e) =>
                            handleChange(contact.id, "ville", e.target.value)
                          }
                        />
                      </label>
                      <label>
                    ...
                    <div className="form-row">
                      <label>
                        ...
                        <input
                          type="text"
                          value={
                            Array.isArray(contact.specialites)
                              ? contact.specialites.join(", ")
                              : ""
                          }
                          onChange={(e) =>
                            handleArrayChange(
                    ...
                    <div className="form-row">
                      <label>
                        ...
                        <input
                          ...
                          value={contact.siret || ""}
                          onChange={(e) =>
                            handleChange(contact.id, "siret", e.target.value)
                          }
                        />
                      </label>
                    </div>
                    <div className="form-row">
                      <label>
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            handleChange(contact.id, "horaires", e.target.value)
                          }
                          rows={3}
                        />
                      </label>
                    ...
                    <div className="form-row">
                      ...
                      <label>
                        ...
                        <textarea
                          value={contact.notes || ""}
                          onChange={(e) =>
                            handleChange(contact.id, "notes", e.target.value)
                          }
                          rows={3}
                        />
                      </label>
                    ...
                    <div className="form-row">
                      ...
                      <label>
                        ...
                        <div className="evaluation-field">
                          {contact.evaluation
                            ? "★".repeat(contact.evaluation) +
                              "☆".repeat(5 - contact.evaluation)
                            : "Non évalué"}
                        </div>
                      </label>
                    </div>
                    <div className="form-row">
                      <label>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange(contact.id, "actif", e.target.checked)
                          }
                        />
                      </label>
                      <label>
                        ...
                        <input
                          ...
                          value={
                            contact.date_ajout
                              ? new Date(contact.date_ajout).toLocaleString()
                              : ""
                          }
                          readOnly
                    ...
                    <div className="form-row">
                      <label>
                        ...
                        <div className="documents-field">
                          {Array.isArray(contact.documents) &&
